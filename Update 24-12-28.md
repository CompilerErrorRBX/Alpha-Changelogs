...
This update we wanted to expand a bit more on crafting and fresh-spawn gameplay. Ths crafting interface has received an overhaul, which should help to address many of the previous iterations shortcomings.
