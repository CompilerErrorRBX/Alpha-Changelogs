# 📑 Changelog 10/26/2025 - 12/06/2025

## 🟢 Status `Released`

## 💬 Patch Notes

We've made many changes to the map this update mainly focused at the airfield and surrounding areas. Additionally we've added new weapons, new ammo types, and new craftables! Try them out with the Airfield event!
________
...
### ✅ `Feature` Item Skin Unlocks
- Picking up items on the ground will unlock them
